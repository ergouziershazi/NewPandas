 ...
 * On 2016/04/18 16:15
 */
public class JCPlayVideo extends JCVideoPlayer {
    ...
    public JCPlayVideo(Context context) {
        super(context);
    }

    public JCPlayVideo(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public static void setOnCollect(OnCollect onCollect) {
        JCPlayVideo.onCollect = onCollect;
    }
