...
public class VideoUtils {
    ...
    public void playVideo(JCPlayVideo jc_video, String video_url, String video_title, String thumb_url) {
        jc_video.setUp(video_url, JCPlayVideo.SCREEN_LAYOUT_NORMAL, video_title);
